...
class Body extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    slivers: [
      ...
      const Recents(),
      const Aviable(),
      const SliverToBoxAdapter(child: SizedBox(height: kBottomNavigationBarHeight * 1.4),
      ),
    ],
    );
  }
    ...
    return SliverToBoxAdapter(child: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          child: Text('Aviable: Kietsu No Yalba', style: Theme.of(context).textTheme.headline6?.copyWith(
            color: Colors.white,
      ...
      child: AspectRatio(
        ...
        child: Column(
          ...
          children: [
            ...
            child: Text('Recently added', style: Theme.of(context).textTheme.headline6?.copyWith(
              color: Colors.white,
              fontWeight: FontWeight.bold
            )),
            ),
              ...
              child: Column(
                ...
                children: [
                  Expanded(child: ClipRRect(
                    ...
                    Text(anime.name, style: Theme.of(context).textTheme.subtitle1?.copyWith(
                      color: Colors.white,
                      fontWeight: FontWeight.bold
                    ),
                    ),
...
class HeaderTrends extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    child: Row(
      children: [
        Expanded(child: Text('Trends', style: Theme.of(context).textTheme.headline6?.copyWith(
          color: Colors.white,
          fontWeight: FontWeight.bold,
        ),
        )
      ),
      Text('View all',style: Theme.of(context).textTheme.subtitle2?.copyWith(
        color: AnimeUiForYoutubeColors.cyan,
